# Functional Python [![](https://github.com/JonathanContreras-bit/functional-python/workflows/tests/badge.svg)](https://github.com/JonathanContreras-bit/functional-python/actions?query=workflow%3Atests)
